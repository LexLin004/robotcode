/* Author: Shihming Lin
  ...
  This example turns on the LED when the microphone
  hears a musical “A” note over a speaker, and off otherwise
*/
...
// Global variables needed for Note A
uint32_t ui32GlobalLoudestFrequency;
...
{
  Serial.begin(115200);
  Serial.println("SparkFun Musical A note demo");
...
void printLoudest(void)
{
  ...
  ui32GlobalLoudestFrequency = ui32LoudestFrequency;
